...
from config import PATH_MIMICIV, PATH_DATA

FPATH_JSON_IMMUNO = PATH_DATA / 'incomplete_icd_immunosuppressed.json'
...
if __name__ == '__main__':
    ...
    opath = FPATH_JSON_IMMUNO.parent / f'full_{FPATH_JSON_IMMUNO.name.split('incomplete_')[1]}'
